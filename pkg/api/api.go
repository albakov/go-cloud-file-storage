...
import (
	"database/sql"
	"github.com/albakov/go-cloud-file-storage/pkg/api/controller/resource"
	"github.com/albakov/go-cloud-file-storage/pkg/service/jwt"
	"github.com/gofiber/swagger"
	"github.com/minio/minio-go/v7"
	"log"

	"github.com/albakov/go-cloud-file-storage/pkg/api/controller/auth"
	"github.com/albakov/go-cloud-file-storage/pkg/api/controller/profile"
	"github.com/albakov/go-cloud-file-storage/pkg/api/middleware"
...
func MustStart(c *config.Config, db *sql.DB, s3client *minio.Client) {
	...
	// resource
	resourceCnt := resource.New(c, s3client)
